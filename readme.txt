=== Tribe Upload Tester ===
Contributors: peterchester, moderntribe
...
1. Visit Settings > Tribe Upload Tester to try it out.

== Frequently Asked Questions ==

= Where can I learn more about integrating the WordPress upload code? =
...
* Manage options for the upload screen so that we can control what tabs are visible etc.
** multiple = false
** type = image
** tab = upload
** disable image from url
** disable gallery